...
func TestLetStatements(t *testing.T) {
	...
	if len(program.Statements) != 3 {
		t.Fatalf("program.Statements doe snot contain 3 statements. got=%d", len(program.Statements))
	}
...
func TestIdentifierExpression(t *testing.T) {
	...
	if ident.TokenLiteral() != "foobar" {
		t.Errorf("ident.TokenLiteral not %s. got=%s", "fobar", ident.TokenLiteral())
	}
}
